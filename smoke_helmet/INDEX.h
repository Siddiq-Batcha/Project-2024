...
<div class="card">
  <h2>Tunnel Construction</h2><br>
  <h1>Smoke status:<span id="ADCValue">0</span></h1><br>
  <h1>Temperature status:<span id="ADCValue2">0</span></h1><br>
  <h1>Temperature :<span id="ADCValue3">0</span></h1><br>
